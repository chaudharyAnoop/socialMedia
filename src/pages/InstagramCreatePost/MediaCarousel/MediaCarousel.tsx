        ...
        <div className={styles.thumbnailStrip}>
          {selectedMedia.map((media, index) => (
            <button
              ...
              className={`${styles.thumbnail} ${index === state.currentMediaIndex ? styles.thumbnailActive : ''}`}
            >
              {media.type === 'image' ? (
                <img src={media.preview} alt={`Thumbnail ${index + 1}`} className={styles.thumbnailImage} />
              ) : (
