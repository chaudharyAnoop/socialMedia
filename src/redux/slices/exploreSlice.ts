...
const mockPosts: Post[] = [
  ...
  },
  {
    id: "7",
    imageUrl:
      "https://images.pexels.com/photos/1462935/pexels-photo-1462935.jpeg?auto=compress&cs=tinysrgb&w=600",
    username: "pet_lover",
    likes: 4321,
    comments: 345,
    isVideo: true,
...
const mockAccounts: Account[] = [
  ...
  },
  {
    ...
    profileImage:
      "https://images.pexels.com/photos/1402787/pexels-photo-1402787.jpeg?auto=compress&cs=tinysrgb&w=100",
    followers: 89000,
    isVerified: false,
  },
  {
  ...
  },
  {
    ...
    profileImage:
      "https://images.pexels.com/photos/1771383/pexels-photo-1771383.jpeg?auto=compress&cs=tinysrgb&w=100",
    followers: 56000,
    isVerified: false,
  },
  {
    ...
    profileImage:
      "https://images.pexels.com/photos/1308881/pexels-photo-1308881.jpeg?auto=compress&cs=tinysrgb&w=100",
    followers: 345000,
    isVerified: true,
  },
  {
    ...
    profileImage:
      "https://images.pexels.com/photos/1559486/pexels-photo-1559486.jpeg?auto=compress&cs=tinysrgb&w=100",
    followers: 187000,
    isVerified: false,
  },
];
...
const exploreSlice = createSlice({
  ...
  reducers: {
    ...
    likePost: (state, action: PayloadAction<string>) => {
      ...
      const searchPost = state.searchResults.posts.find(
    ...
    setSearchQuery: (state, action: PayloadAction<string>) => {
      ...
      if (action.payload.length > 0) {
        ...
        state.searchResults.posts = state.posts.filter((post) =>
